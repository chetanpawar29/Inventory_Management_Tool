...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Page Content Holder -->
      <%
	List<IssueProcessed> iProcessedList = (List<IssueProcessed>) request.getAttribute("iProcessedList");
	...
	%> 
        ...
        <div id="content">
            <!-- top-bar -->
             <h2 class="main-title-w3layouts mb-2 text-center">Issue Processed Items Logs</h2>
            ...
            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                    ...
                    <table class="table table-striped">
						...
						for(IssueProcessed ip : iProcessedList)
			{
				%>
          ...
          <tr>
				...
				<td><%=ip.getPname()%></td>
				<td><%=ip.getpQuantity() %></td>
				<td><%=ip.getPid()%></td>
				<td><%=ip.getIssueDate()%></td>
				<td><%=ip.getIssueTime()%></td>
