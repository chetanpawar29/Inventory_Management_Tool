            ...
            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            ...
                            <form action="#" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="newPass" class="form-control" id="inputEmail3" placeholder="Enter New Password" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Old Password</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="oldPass" class="form-control" id="inputEmail3" placeholder="Enter Old Password" required="">
                                    </div>
                                </div>
