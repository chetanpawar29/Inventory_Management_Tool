    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            <h4 class="tittle-w3-agileits mb-4">Add Raw Material</h4>
                            <form action="AddRawMaterial" method="post">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="rname" class="form-control" id="inputEmail3" placeholder="Enter Raw Material Name" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <fieldset class="form-group" >
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"  name="rCostPerUnit" class="form-control" id="inputPassword3" placeholder="Enter Cost" >
                                    </div>
                                </div>
                                <div class="form-group row">
