    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            <h4 class="tittle-w3-agileits mb-4">Update Quantity Processed Item</h4>
                            <form action="updateProcessedItemQty" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="pQuantity" class="form-control" id="inputEmail3" placeholder="Enter Raw Material Quantity" required="">
                                    </div>
                                </div>
