...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Page Content Holder -->
        <%
	List<RawMaterial> rawList = (List<RawMaterial>) request.getAttribute("rawList");
	
	%>
        
        <div id="content">
            <!-- top-bar -->
             <h2 class="main-title-w3layouts mb-2 text-center">Raw Materials</h2>
            ...
            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                    ...
                    <table class="table table-striped">
						...
						for(RawMaterial raw : rawList)
			{
				if(raw.getrQuantity()>5)
				{
			%>
				...
				<td><%=raw.getrUnit() %></td>
				<td>Rs. <%=raw.getrCostPerUnit()%></td>
				<%
				if(raw.getrQuantity()>0)
				{%>
					<td><button style="background-color: green"><a href="openIssueRawMaterial?rid=<%=raw.getRid()%>&rname=<%=raw.getRname()%>">Issue</a></button></td>
					<td><button style="background-color: yellow;"><a href="openUpdateRawMaterialQty?rid=<%=raw.getRid()%>">Update Qty</a></button></td>
				<%}
					%>
					
					<td><button style="background-color: red"><a href="deleteRawMaterial?rid=<%=raw.getRid()%>">Delete</a></button></td>
			</tr>
			<% 
				}
			}%>
