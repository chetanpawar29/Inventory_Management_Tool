...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Page Content Holder -->
       <%
	List<IssueRaw> iRawList = (List<IssueRaw>) request.getAttribute("iRawList");
	...
	%> 
        ...
        <div id="content">
            <!-- top-bar -->
             <h2 class="main-title-w3layouts mb-2 text-center">Issue Raw Materials Logs</h2>
            ...
            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                    ...
                    <table class="table table-striped">
						...
						for(IssueRaw raw : iRawList)
			{
				%>
                        
          <tr>
				<td><%=raw.getIrId()%></td>
				<td><%=raw.getIssuerName() %></td>
				<td><%=raw.getRname()%></td>
				<td><%=raw.getrQuantity() %></td>
				<td><%=raw.getRid()%></td>
				<td><%=raw.getIssueDate()%></td>
				<td><%=raw.getIssueTime()%></td>
